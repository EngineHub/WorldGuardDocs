...
.. tip::
    If overlapping regions have the same greeting or farewell flag, no message is sent when moving between these regions, i.e. if you enter one region while being in the other.
